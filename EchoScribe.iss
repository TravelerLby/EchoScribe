...
[Files]
Source: "dist\EchoScribe-v1.1.1.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\EchoScribe"; Filename: "{app}\EchoScribe-v1.1.1.exe"
Name: "{group}\{cm:UninstallProgram,EchoScribe}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\EchoScribe"; Filename: "{app}\EchoScribe-v1.1.1.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\EchoScribe"; Filename: "{app}\EchoScribe-v1.1.1.exe"; Tasks: quicklaunchicon

[Run]
Filename: "{app}\EchoScribe-v1.1.1.exe"; Description: "{cm:LaunchProgram,EchoScribe}"; Flags: nowait postinstall skipifsilent
